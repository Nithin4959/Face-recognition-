...
def faceDetection(test_img):             
    ...
    face_haar=cv2.CascadeClassifier(r'F:\projects of machine learning\face recogonition\haarcascade_frontalface_alt.xml') #Give path to haar classifier as i have given
